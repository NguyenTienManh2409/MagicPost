                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li><a href="\MagicPost\frontend\Leader\workplace.php"><i class="la la-users"></i> <span>Nơi làm việc</span></a></li>
							<li class="menu-title"> 
								<span>Quản lý tài khoản</span>
							</li>
							<li><a href="\MagicPost\frontend\Leader\PointLeaderAccount.php"><i class="la la-users"></i> <span>Tài khoản trưởng điểm</span></a></li>
